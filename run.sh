...
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 100 --dp_clip 50 --gpu 1 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 75 --dp_clip 50 --gpu 0 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 50 --dp_clip 50 --gpu 0 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 25 --dp_clip 50 --gpu 0 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 10 --dp_clip 50 --gpu 0 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 5 --dp_clip 50 --gpu 0 --frac 0.2
python3 main.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 1 --dp_clip 50 --gpu 0 --frac 0.2
